...
class DataLoaderDenoising():
    def __init__(self, batch_size, workers):
        ...
        self.trainloader = torch.utils.data.DataLoader(NoisyDataset(dataset_dir), batch_size=batch_size, shuffle=True, num_workers=workers)
        ...
        self.validationloader = torch.utils.data.DataLoader(NoisyDataset(dataset_dir, mode='test', img_size=(320, 320)), batch_size=batch_size, shuffle=True, num_workers=workers)
