...
class DataLoaderDenoising():
    def __init__(self, batch_size, batch_size_un, workers):
        ...
        self.trainloader_un = torch.utils.data.DataLoader(NoisyDatasetUn(dataset_dir_un_coco, 'train', (50,50), batch_size=batch_size_un), batch_size=batch_size_un, shuffle=True, num_workers=workers, pin_memory=True)
        ...
        self.validationloader_coco = torch.utils.data.DataLoader(NoisyDatasetUn(dataset_dir_un_coco, 'val',img_size=(480, 320), batch_size=batch_size), batch_size=batch_size, shuffle=True, num_workers=workers, pin_memory=True)
