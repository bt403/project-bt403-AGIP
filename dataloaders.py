...
class DataLoaderDenoising():
    def __init__(self, batch_size, batch_size_un, workers):
        ...
        self.validationloader = torch.utils.data.DataLoader(NoisyDatasetUn(dataset_dir_un_1_gt, dataset_dir_un_1_noisy, mode='test', img_size=(480, 320)), batch_size=1, shuffle=True, num_workers=workers)
