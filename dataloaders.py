...
class DataLoaderDenoising():
    def __init__(self, batch_size, batch_size_un, workers):
        ...
        self.trainloader_un = torch.utils.data.DataLoader(NoisyDataset(dataset_dir_sup_1, dataset_dir_sup_2, dataset_dir_sup_3, 'train', (50,50)), batch_size=batch_size, shuffle=True, num_workers=workers, pin_memory=True)
        ...
        self.validationloader = torch.utils.data.DataLoader(NoisyDatasetUn(dataset_dir_un_1_gt, dataset_dir_un_1_noisy, mode='test', img_size=(480, 320)), batch_size=batch_size, shuffle=True, num_workers=workers)
