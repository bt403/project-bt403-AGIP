...
class DataLoaderDenoising():
    def __init__(self, batch_size, batch_size_un, workers):
        ...
        self.validationloader_coco = torch.utils.data.DataLoader(NoisyDatasetUn(dataset_dir_un_coco, mode='val',img_size=(640, 424), batch_size=batch_size), batch_size=1, shuffle=True, num_workers=workers, pin_memory=True)
