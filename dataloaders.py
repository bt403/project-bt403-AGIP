...
class DataLoaderDenoising():
    def __init__(self, batch_size, workers):
        ...
        self.trainloader_un = torch.utils.data.DataLoader(NoisyDatasetUnsup(dataset_dir_un, dataset_dir_un_coco), batch_size=batch_size, shuffle=True, num_workers=workers) # The batch size for unsupervised data is more than supervised data
