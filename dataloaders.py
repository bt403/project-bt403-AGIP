...
class DataLoaderDenoising():
    def __init__(self, batch_size, batch_size_un, workers):
        ...
        self.validationloader_coco = torch.utils.data.DataLoader(NoisyDatasetUn(dataset_dir_un_coco, 'val',img_size=(480, 320), batch_size=batch_size), batch_size=1, shuffle=True, num_workers=workers, pin_memory=True)
