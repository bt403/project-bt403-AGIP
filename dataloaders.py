...
class DataLoaderDenoising():
    def __init__(self, batch_size, batch_size_un, workers):
        ...
        self.trainloader_un = torch.utils.data.DataLoader(NoisyDatasetUn(dataset_dir_un_coco, dataset_dir_sup_1, dataset_dir_sup_2, dataset_dir_sup_3, mode='train', (50,50), batch_size=batch_size_un), batch_size=batch_size_un, shuffle=True, num_workers=workers, pin_memory=True)
